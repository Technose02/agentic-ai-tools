use aat_fs::{
    filesizetool::{FileSizeToolService, SimpleFileSizeAdapter, create_file_size_tool},
    readchunktool::{
        SimpleReadChunkAdapter, SizeAwareReadChunkToolService, create_read_chunk_tool,
    },
    translate_de,
};
