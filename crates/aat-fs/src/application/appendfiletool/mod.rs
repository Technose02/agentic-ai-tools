use crate::{
    ...
    domain::{model::appendfiletool::InputParams, port::appendfiletool::AppendFileToolInPort},
    error::{Error, TError},
};
...
mod de;
mod en;
pub use de::create_append_file_tool_de;
pub use en::create_append_file_tool_en;

fn create_append_file_tool<P, R, S, T>(description: &'static str, service: S) -> Arc<FunctionTool>
where
    ...
    T: ErrorTranslator + 'static,
{
    ...
    Arc::new(
        FunctionTool::new("append_file_tool", description, handler)
